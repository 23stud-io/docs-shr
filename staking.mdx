---
title: 'Staking'
description: 'Understand the staking mechanism of the ShroomyProject protocol'
---

The ShroomyProject staking mechanism is a core component of the protocol's economic model, designed to incentivize token holders who actively participate in securing and governing the ecosystem. By staking SHR tokens (the native token of ShroomyProject), participants receive protocol-derived incentives and gain governance rights proportional to their stake.
...
- **Protocol Governance**: Participate in governance decisions that shape the future of ShroomyProject
...
1. **Deposit**: Users deposit SHR tokens into the staking contract
...
A unique feature of ShroomyProject staking is that rewards maintain their original form:
...
ShroomyProject offers four fixed staking lock periods:
