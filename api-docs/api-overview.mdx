---
title: 'API Overview'
description: 'Understand the API of TEPHRA.'
---

The **TEPHRA Swap API** provides unified access to aggregated liquidity across multiple decentralized exchange networks on the ink blockchain.

It serves as a central integration layer that allows developers to query token prices, generate optimized swap quotes, and execute transactions through **TEPHRA**’s aggregation engine.
...
This includes decentralized exchanges, market makers, and off-chain RFQ providers integrated with the **TEPHRA** protocol.
...
**To obtain an API key, contact the **TEPHRA** team or your integration partner.**
